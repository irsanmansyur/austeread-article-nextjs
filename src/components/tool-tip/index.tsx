  ...
  return (
    ...
    >
      ...
      {show && text && (
        <span
          ref={toolTipRef}
          className={`invisible group-hover:visible p-1 rounded absolute top-full mt-1 left-1/2 -translate-x-1/2 sm:whitespace-nowrap bg-slate-700 text-white text-xs`}
